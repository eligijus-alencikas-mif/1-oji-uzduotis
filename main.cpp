...
int main() {
    ...
    choice = numInput("Pasirinkite kodo versija (1 - naudojant tik vektorius, 2 - naudojant c masyva namu darbams saugoti): ");
    ...
    if (use_vec_ver) {
        ...
        use_c_arr(use_median, generate_names, generate_grades);
    }
    return 0;
}
