...
void Output_students::output_students(std::deque<Student> const &students, const bool &out_to_file)
{
    try
    {
        if (out_to_file)
...
void Output_students::output_file(std::deque<Student> const &students)
{
    try
    {
        this->output
...
void Output_students::output_terminal(std::deque<Student> const &students)
{
    try
    {
        cout << '\n'
