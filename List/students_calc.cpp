...
void Calc_Students::calc_grades(std::list<Student> &students)
{
...
void Calc_Students::sort_students(std::list<Student> &students, int sort_method)
{
    switch (sort_method)
    {
    case 1:
        students.sort(student_sort_f_name);
        // std::sort(students.begin(), students.end(), student_sort_f_name);
        break;
    case 2:
        students.sort(student_sort_l_name);
        // std::sort(students.begin(), students.end(), student_sort_l_name);
        break;
    case 3:
        students.sort(student_sort_avg);
        // std::sort(students.begin(), students.end(), student_sort_avg);
        break;
    case 4:
        students.sort(student_sort_med);
